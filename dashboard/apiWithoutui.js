...
const collection = client.db('anumongo').collection('dashboard');
...
app.put('/deactivatedUser',async(req,res) => {
    ...
    req.send('User Deactivated')
})

// activated user(soft delete)
